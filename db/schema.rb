...
ActiveRecord::Schema.define(:version => 20130302164907) do
  ...
  add_index "classroom_disciplines", ["teacher_id"], :name => "index_classroom_disciplines_on_teacher_id"
  ...
  add_foreign_key "classroom_disciplines", "teachers", :name => "classroom_disciplines_teacher_id_fk", :dependent => :nullify
